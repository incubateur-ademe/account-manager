...
Deploiement autoheberge. Ce projet est deja en `output: 'standalone'` (voir `next.config.ts`)
et tourne en conteneur, avec la collecte lancee en conteneur one-off par le cron de la plateforme.
