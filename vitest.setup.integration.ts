 ...
 * Le nom de la base doit finir par `_test`, et rien d'autre ne sert de garde : ni le
 * nom de l'hôte, qu'un tunnel déguise, ni `NODE_ENV`, qu'un lanceur pose à côté de la
 * plaque.
 */
